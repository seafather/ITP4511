...
<div class='row'>
            ...
            <nav1 class='nav'>
                <div>
                    ...
                    <div class='nav_list'>
                        ...
                        <a href='OrderController?action=check-out' class='nav_link active1'>
    ...
    <div class="col l10 ">
        ...
        <div class="z-depth-1" style="padding: 10px; height: 200px;margin-bottom: 50px;">

            <h5>Select location</h5>

            <form class="col s12" action="OrderProcess" method="post">
                <input type="hidden" name="page" value="check-out">
